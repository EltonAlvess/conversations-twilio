      ...
      <li id={m.sid} className={itemStyle}>
        <div className={divStyle}>
          <div>
            <strong>
              {type === "whatsapp" && (
                <SmileOutlined style={{ fontSize: "16px" }} component={WhatsappIcon} />
              )}
              {type === "chat" && (
                <SmileOutlined style={{ fontSize: "16px" }} component={ChatIcon} />
              )}
              {type === "sms" && <SmileOutlined type={"mobile"} />}
              {` ${m.author}`}
            </strong>
          ...
          Modal.info({
            ...
            content: (
              <div className={styles.picture_container}>
                <img alt="pic-container" style={{ width: "100%", height: "100%" }} src={url} />
              </div>
            )
          });
        }}
      >
        ...
        {hasFailed && (
          <div style={{ display: "flex", flexDirection: "column" }}>
            <SmileOutlined type={"warning"} style={{ fontSize: "5em" }} />
        ...
        {!hasFailed && url && (
          <div className={styles.media_icon}>
            <div style={{ zIndex: 123, position: "absolute" }}>
              <SmileOutlined type={"eye"} style={{ fontSize: "5em", opacity: 0.3 }} />
            </div>
            <div
